...
public record SkuDto(Guid Id, string Name, string SkuCode, decimal Price, string Currency, int StockTotal, bool Active, bool IsDigital, bool IsDefault, int SoldQty);
    ...
    public static ProductDto ToDto(this Product p) =>
        new(
            ...
            p.Skus
                ...
                .ThenBy(s => s.Name)
                .Select(s => new SkuDto(s.Id, s.Name, s.SkuCode, s.Price, s.Currency, s.StockTotal, s.Active, s.IsDigital, s.IsDefault, s.SoldQty))
                .ToList(),
            p.ProductMechanics
